...
##
golem::fill_desc(
  pkg_name = "golem_book", # The name of the golem package containing the app (typically lowercase, no underscore or periods)
...
golem::use_favicon("inst/img/experiment_16584785.png") # path = "path/to/ico". Can be an online file.
...
usethis::use_git_remote(
  name = "origin",
  url = "https://github.com/l1m40/golem_book.git"
)
